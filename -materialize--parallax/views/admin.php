...
<p>
    <label for="<?php echo $this->get_field_id('link_1_url'); ?>">Modal ID</label>
    <input class="widefat"
...
<div style="background-color: rgba(0, 115, 170, 0.15);">
    <p>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('modal_textarea'); ?>">Modal Textarea</label>
        <textarea class="widefat"
                  rows="5"
                  id="<?php echo $this->get_field_id('modal_textarea'); ?>" 
                  name="<?php echo $this->get_field_name('modal_textarea'); ?>"
                  type="text" 
                  value="<?php echo $modal_textarea ?>"
                  ><?php echo $textarea ?>
        </textarea>
    </p>

    <p>
        <label for="<?php echo $this->get_field_id('modal_link_2'); ?>">Modal Button Text</label>
        <input class="widefat"
    ...
    <p>
        <label for="<?php echo $this->get_field_id('modal_link_2_url'); ?>">Modal Button URL</label>
        <input class="widefat"
