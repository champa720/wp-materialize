 ...
 *
 * @wordpress-plugin
 * Plugin Name:       (Materialize) Icon Card
 * Plugin URI:        http://materializecss.com/cards.html
 * Description:       Here is the standard card with an icon thumbnail.
 * Version:           1.0.0
 * Author:            Jason Kilpatrick
 * Author URI:        @TODO
 * Text Domain:       card_icon
 * License:           GPL-2.0+
...
class card_icon extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'card_icon';
	...
	public function __construct() {
		...
		parent::__construct(
			...
			__( '(Materialize) Icon Card', $this->get_widget_slug() ),
			array(
				'classname'  => $this->get_widget_slug(),
				'description' => __( 'Here is the standard card with an icon thumbnail.', $this->get_widget_slug() )
			)
		);
...
add_action( 'widgets_init', create_function( '', 'register_widget("card_icon");' ) );
