<div class="col s12 no-padding">
    <div class="parallax-container valign-wrapper <?php echo $select_1; ?> <?php echo $select_2; ?>">
        <div class="container">
            ...
            <p class="flow-text" style="display:none"><?php echo $textarea; ?></p>
        ...
        <div id="mc_embed_signup_scroll">
            <h4 style="display:none"><?php echo $modal_title ?></h4>
            ...
            <option value="16" selected>Yes</option>
            ...
            <ul>
            <li>
            <input type="checkbox" value="1" name="group[14905][1]" id="mce-group[14905]-14905-0" checked><label for="mce-group[14905]-14905-0">General News</label>
            </li>
            <li>
            <input type="checkbox" value="2" name="group[14905][2]" id="mce-group[14905]-14905-1" checked><label for="mce-group[14905]-14905-1">Events and Conferences</label>
            </li>
            <li>
            <input type="checkbox" value="4" name="group[14905][4]" id="mce-group[14905]-14905-2" checked><label for="mce-group[14905]-14905-2">Legislative Alerts</label>
            </li>
            <li>
            <input type="checkbox" value="8" name="group[14905][8]" id="mce-group[14905]-14905-3" checked><label for="mce-group[14905]-14905-3">Volunteer Opportunities</label>
            </li>
            </ul>
            </div>
            </div>
            ...
            <div class="row">
            <div class="col s12">
            <button type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="btn-large col s4">Subscribe&emsp;<span class="fa fa-thumbs-o-up"></span></button>
            <div id="mce-responses" class="clear col s8">
